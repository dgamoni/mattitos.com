...
<?php if ( is_home() && x_get_option( 'x_integrity_blog_header_enable' ) == '1' ) : ?>
  <div class="single-custom-header" style="margin-bottom: 80px;">
...
<?php elseif ( is_category() || x_is_portfolio_category() ) : ?>
  ...
  <div class="single-custom-header" style="margin-bottom: 80px;">
    <div class="x-container max width offset">
      <h2>See what's trending<br><strong>Category</strong></h2>
    </div>
  </div>
...
<?php elseif ( is_tag() || x_is_portfolio_tag() ) : ?>
  ...
  <div class="single-custom-header" style="margin-bottom: 80px;">
    <div class="x-container max width offset">
      <h2>See what's trending:<br><strong>Tags</strong></h2>
    </div>
  </div>
...
<?php elseif ( is_year() ) : ?>
  ...
  <div class="single-custom-header" style="margin-bottom: 80px;">
    <div class="x-container max width offset">
      <h2>See what's trending<br><strong>Post Archive</strong></h2>
    </div>
  </div>
